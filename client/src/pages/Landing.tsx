        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-sans text-3xl sm:text-4xl font-bold text-foreground mb-4 tracking-tight">
              Servicios de Desarrollo de Software en Itapúa para Negocios y Consultorios
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              En Carlos Antonio López, Mayor Otaño e Itapúa, brindamos soluciones tecnológicas completas: desarrollo web, apps móviles, facturación electrónica SIFEN y mantenimiento para empresas paraguayas.
            </p>
          </motion.div>
      ...
      <section id="precios" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-muted/20 via-background to-muted/30">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">Planes y Servicios Itapúa</Badge>
            <h2 className="font-sans text-4xl sm:text-5xl font-bold text-foreground mb-6 tracking-tight">
              Planes de Desarrollo Web en Carlos Antonio López e Itapúa
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Soluciones ideales para negocios y consultorios en Carlos Antonio López, Mayor Otaño y todo Itapúa. Paquetes completos de desarrollo de software, facturación electrónica y mantenimiento web.
            </p>
          </motion.div>
          ...
          {/* SEO Itapúa Section */}
          <section id="itapua-servicios" className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50 border-t border-b border-slate-100">
            <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">
                Atendemos Empresas y Consultorios en Itapúa
              </h2>
              <p className="text-lg text-slate-600 mb-10 max-w-3xl mx-auto">
                Brindamos servicios de desarrollo web, sistemas personalizados y digitalización empresarial en Carlos Antonio López, Mayor Otaño y todo el departamento de Itapúa. Ofrecemos soporte remoto y asesoramiento profesional adaptado a la realidad local.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 text-left">
                {[
                  { text: "Desarrollo web en Carlos Antonio López", link: "/desarrollo-web-carlos-antonio-lopez" },
                  { text: "Sistemas de turnos online en Mayor Otaño", link: "/sistemas-en-mayor-otano" },
                  { text: "Digitalización de negocios en Itapúa", link: "/software-en-itapua" },
                  { text: "Soporte técnico y mantenimiento local", link: "#contacto" }
                ].map((item, i) => (
                  <div 
                    key={i} 
                    className="flex items-center p-4 bg-white rounded-lg shadow-sm border border-slate-100 hover:border-primary/30 transition-colors cursor-pointer"
              ...
              <Button 
                size="lg" 
                onClick={() => window.open('https://wa.me/595985990046', '_blank')}
                className="bg-[#25D366] hover:bg-[#128C7E] text-white font-bold px-8 py-4 h-auto text-lg rounded-full shadow-lg transform hover:scale-105 transition-all"
              >
